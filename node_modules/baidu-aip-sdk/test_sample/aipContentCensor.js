...
let fs = require('fs');
let imageCensor = require('../src/index').contentCensor;
let bitmap = fs.readFileSync('/Users/lidang/Downloads/test.png');
...
// let client=new AipContentCensorClient(12323, 'WpzmnDNs8LTqu71CedRaASIG', 'jjn2KIPjvm4TlgnpcbZShysfGcIAhI1L');
// client.antiSpam('我是广告').then(function(data) {
//     console.log('<antiSpam>: ' + JSON.stringify(data));
// });
...
// });
 ...
 client.textCensorUserDefined('base64').then(function(data) {
